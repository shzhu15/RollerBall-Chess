...
# Traceability Link Matrix - Client Side
 ...
 | I want to be able to start a match                                                  |               |                |             |                   |
  ...
  | I want to be able to see the game board associated with the game I am playing      |               |                |             |                   |
  | I want to be able to register for an account                                       |               |                |             |                   |
  | I want to be able to login to my account                                           |               |                |             |                   |
  | I want to be able to logout of my account                                          |               |                |             |                   |
  | I want my past and current games to be displayed after logging in                  |               |                |             |                   |
  ...
  | I want to be able to view a history of all games that I have played                |               |                |             |                   |
